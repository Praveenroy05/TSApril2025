...
// 2. Comparison Operation  - It compares the values and return the result in the form of boolean  (true or false)
...
console.log("Strict Equality", m === n) 
